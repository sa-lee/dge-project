...
If you want to obtain only the R-code from the rmarkdown file, simply clone the repositry then type the following into the console:
```{r}
library(knitr)
purl("analysis_writeup.Rmd")
```
